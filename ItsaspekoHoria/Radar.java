...
public class Radar extends Arma {
	...
	public void erabili(Taula etsaiarenTaula, int pX, int pY){
		...
		if (pX>0&&pY>0&&etsaiarenTaula.getOntzia(pX-1,pY-1).getEgoera() instanceof OntziaDago)etsaiarenTaula[pX-1][pY-1].koloreAldatu();	   if (pX>0&&etsaiarenTaula[pX-1][pY].getEgoera() instanceof OntziaDago)etsaiarenTaula[pX-1][pY].koloreAldatu();  
